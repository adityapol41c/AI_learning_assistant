      ...
      <div className='relative max-w-7xl mx-auto'>
        ...
        <div className='bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-2xl shadow-xl shadow-slate-200/60 p-8'>
          <div className='flex items-center gap-3 mb-6'>
            <div className='w-10 h-10 rounded-xl bg-linear-to-br from-slate-100 to-slate-100 flex items-center justify-center'>
              ...
              {[
                ...
                .map((activity, index) => (
                  <div
                    ...
                    className='group flex items-center justify-center p-4 rounded-xl bg-slate-50/50 border border-slate-200/60 hover:bg-white hover:border-slate-300/60 hover:shadow-md transition-all duration-200'
                  >
                    <div className='flex-1 min-w-0'>
                      <div className='flex items-center gap-2 mb-1'>
                        ...
                        />
                        <p className='text-sm font-medium text-slate-500 pl-4'>
                          {activity.type === 'document'
                            ? 'Accessed Document: '
                            : 'Attempted quiz '}

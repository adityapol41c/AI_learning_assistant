  ...
  return (
      <div className="flex items-center justify-center min-h-screen bg-linear-to-br from-slate-50 via-white to-slate-50">
          ...
          <div className='relative w-full max-w-md px-6'>
            <div className='bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-3xl rounded-3x1 shadow-xl shadow-slate200/50 p-10'>
              {/*header*/}
              ...
              <div className='space-y-5'>
                  ...
                  >
                    <span className='relative z-10 flex items-center justify-center gap-2'>
                        {loading ? (
                            <>
                            <div className='w-4 h-2 border-2 border-white/30 border-t-white rounded-full animate-spin'>Signing in...</div>
                            </>
                        ) : (
                            <>
                            Sign in 

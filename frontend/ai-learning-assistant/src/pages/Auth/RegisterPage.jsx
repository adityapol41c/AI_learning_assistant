...
const RegisterPage = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-linear-to-br from-slate-50 via-white to-slate-50">
      <div className='absolute inset-0 bg-[radial-gradient(#e5e7eb_1px, transparent_1px)] bg-size[16_16px opacity-30'></div>
      <div className='relative w-full max-w-md px-6'>
        <div className='bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-3xl rounded-3x1 shadow-xl shadow-slate200/50 p-6'>
          ...
          <div className='text-center mb-6'>
              <div className='inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-linear-to-br from-emerald-400 to-teal-500 shadow-lg shadow-emerald-500/25 mb-6'>
                  <BrainCircuit className='w-7 h-7 text-white' strokeWidth={2}></BrainCircuit>
              </div>
          ...
          <div className='space-y-4'>
            ...
            <div className='space-y-2'>
              ...
              <div className='relative group'>
                ...
                <input
                  ...
                  className='w-full h-11 pl-12 pr-4 border-2 border-slate-200 rounded-xl bg-slate-50/50 text-slate-900 placeholder-slate-400 text-sm font-medium transition-all duration-200 focus:outline-none focus:border-emerald-500 focus:bg-white focus:shadow-lg focus:shadow-emerald-500/10'
            ...
            {/* error message  */}
            {error && (
              <div className='rounded-lg bg-red border border-red-200 p-3'>
            ...
            >
              <span className='relative z-10 flex items-center justify-center gap-2'>
                {loading ? (
                  <>
                    <div className='w-4 h-4 border-white/30 border-t-white rounded-full animate-spin'>creating account...</div>
                  </>
                ) : (
                  <>
                    create account 
                    <ArrowRight className='w-4 h-4 group-hover:translate-x-1 transition-transform duration-200' strokeWidth={2.5}></ArrowRight>
                  </>
                )}
              </span>

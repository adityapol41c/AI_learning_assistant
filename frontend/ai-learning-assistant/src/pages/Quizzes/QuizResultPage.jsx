...
const QuizResultPage = () => {
  ...
  return (
    <div className='max-w-5xl mx-auto'>
      {/* back button  */}
      <div className='group inline-flex items-center gap-2 text-sm font-medium text-slate-600 hover:text-emerald-600 transition-colors duration-200'>
        ...
        <div className='text-center space-y-6'>
          ...
          <div className='flex items-center justify-center gap-4 pt-4'>
            ...
            <div className='flex items-center gap-2 px-4 py-2 bg-emerald-50 border border-emerald-200 rounded-xl'>
              ...
              <span className='text-sm font-semibold text-emerald-700'>{correctAnswer} Correct</span>
            </div>
      ...
      <div className='space-y-6'>
        <div className='flex items-center gap-3 mb-2'>
          ...
          <h3 className='text-ls font-semibold text-slate-900'>Detailed review</h3>
        </div>
        ...
        <Link to={`/documents/${quiz.document._id}`}>
          <button className='group relative px-8 h-12 bg-linear-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white font-semibold text-sm rounded-xl transition-all duration-200 shadow-lg shadow-emerald-500/25 active:scale-95 overflow-hidden'>
            <span className='relative z-10 flex items-center gap-2'>
              <ArrowLeft className='w-4 h-4 group-hover:-translate-x-1 transition-transform duration-200' strokeWidth={2.5} />Return to document
            </span>

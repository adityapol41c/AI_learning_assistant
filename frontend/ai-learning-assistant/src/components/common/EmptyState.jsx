...
const Emptystate = ({onActionClick, title, description, buttonText}) => {
  return (
    <div className='flex flex-col items-center justify-center py-15 px-6 text-center bg-linear-to-br from-slate-50/50 to-white border-2 border-dashed border-slate-200 rounded-3xl'>
        ...
        {buttonText && onActionClick && (
            ...
            >
                <span className='relative z-10 flex items-center gap-2'>
                    <Plus className='w-4 h-4' strokeWidth={2} />{buttonText}
                </span>

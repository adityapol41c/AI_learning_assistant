...
import { Send, MessagesSquare, Sparkles, MessageSquare, Sparkle } from 'lucide-react';
...
const ChatInterface = () => {
  ...
  return (
    <div className='flex flex-col h-[70vh] bg-white/80 backdrop-blur-xl border border-200/60 rounded-2xl shadow-xl shadow-slate-200/50'>
        {/* messages area  */}
        <div className='flex-1 p-6 overflow-y-auto bg-linear-to-br from-slate-50/50 via-white/50 to-slate-50/50'>
            {history.length === 0 ? (
                <div className='flex flex-col items-center justify-center h-full text-center'>
                    ...
                    <h3 className='test-base font-semibold text-slate-900 mb-2'>Start a conversation</h3>

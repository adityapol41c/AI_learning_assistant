   ...
   const renderFlashcardViewer = () => {
    ...
    return (
        <div className='space-y-8'>
            ...
            >
                <ArrowLeft className='w-4 h-4 group-hover:-translate-x-1 transition-transform duration-200' strokeWidth={2} />Back to sets
            </button>
   ...
   const renderSetList = () =>{
    ...
    if(flashcardSets.length === 0){
        ...
        <div className='flex flex-col items-center justify-center py-16 px-6'>
            <div className='inline-flex items-center justify-center w-16 h-16 rounded-xl bg-linear-to-br from-emerald-100 to-teal-100 mb-6'>
            ...
            >
                {generating ? (
                    ...
                    <>
                        <Sparkles className='w-4 h-4' strokeWidth={2} />Generate Flashcard
                    </>
                )}
            </button>
        </div>
                    ...
                    >
                        ...
                        <div className='space-y-4'>
                            ...
                            <div>
                                ...
                                <p className='text-xs font-medium text-slate-600 uppercase tracking-wide'>Created {moment(set.createdAt).format('MMM D,YYYY')}</p>
                            </div>
        ...
        >
            <div className='space-y-6'>
                <p className='text-sm text-slate-600'>
                    ...
                    and all the cards will be permanently deleted.
                </p>
